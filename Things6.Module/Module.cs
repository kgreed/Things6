...
namespace Things6.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class Things6Module : ModuleBase {
        static Things6Module() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<Things6DbContext>());
            // #endif 
        }
        public Things6Module() {
            InitializeComponent();
